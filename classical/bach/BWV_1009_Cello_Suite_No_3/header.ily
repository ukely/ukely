\header {
    ...
    style = "Baroque"
    maintainer = "Stelios Samelis, ukulele by Jordan Anderson"
    lastupdated = "2017/November/20"
    version = "2.20.0"
    moreinfo = "A transposition to viola is available in the source zip file."
    license = "Public Domain"
    footer = "Mutopia-2018/01/29-890"
